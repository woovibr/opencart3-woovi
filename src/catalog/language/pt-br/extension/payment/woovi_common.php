...
$_["Confirm Order"] = "Confirmar pedido";

$_["No order ID in the session!"] = "Nenhum ID do pedido na sessão!";
$_["Payment method is incorrect!"] = "A forma de pagamento está incorreta!";
$_["There is already a charge for this order!"] = "Já existe uma cobrança para este pedido!";

$_["CPF/CNPJ invalid! Change the CPF/CNPJ field in your account settings page or on this page if you see the field."] = "CPF/CNPJ inválido! Altere o campo CPF/CNPJ na página de configurações da sua conta ou nesta página, caso veja o campo.";
$_["CPF/CNPJ invalid!"] = "CPF/CNPJ inválido!";
